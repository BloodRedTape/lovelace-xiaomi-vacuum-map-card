...
import { FurnitureConfig } from "./model/map_objects/furniture";
...
export class XiaomiVacuumMapCardEditor extends LitElement implements Omit<LovelaceCardEditor, "hass"> {
    ...
    constructor() {
        ...
        this._handleNewFurniture = this._handleNewFurniture.bind(this);
    ...
    connectedCallback(): void {
        ...
        window.addEventListener(EVENT_FURNITURE_CHANGED, this._handleNewFurniture);
    ...
    disconnectedCallback(): void {
        ...
        window.removeEventListener(EVENT_FURNITURE_CHANGED, this._handleNewFurniture);
    ...
    private _handleNewFurniture(e: Event): void {
        const furniture: FurnitureConfig[] = (e as any).furniture

        if (this._config) {
            this._setConfig({ ...this._config, furniture: furniture });
        }
    }
